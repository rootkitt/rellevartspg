...
// Points
extern NSString *const kYouMiEarnedPointsResponseNotification;      //查询能量点请求成功
extern NSString *const kYouMiEarnedPointsResponseErrorNotification; //查询能量点请求失败
// View
...
extern NSString *const kYouMiEarnedPointsPoinstsOpenKey;     // 获得的能量点[NSNumber]
...
// 查询能量点情况成功
// @info 里面包含 [能量点记录] 的 NSDictionary
//
// 说明:
//      能量点查询请求成功后回调该方法
...
#define kOneAccountRecordPoinstsOpenKey     kYouMiEarnedPointsPoinstsOpenKey    // 获得的能量点[NSNumber]
