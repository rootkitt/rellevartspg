...
- (void)updateCheckCallBack:(NSDictionary *)appInfo
{
    if (self.mIsCheckingUpdate)
    {
        ...
        NSString* sCurVersion = [[NSBundle mainBundle] objectForInfoDictionaryKey: @"CFBundleVersion"];
        NSString* sNewVersion = [appInfo objectForKey:@"version"];
        
        if (sNeedUpdate
            && [sNewVersion compare:sCurVersion options:NSNumericSearch] == NSOrderedDescending)
        {
